...
function DashboardRoutes() {
  return <DashboardLayout><Switch><Route path="/" component={Home} /><Route path="/adoption" component={ManualAdoption} /><Route path="/history" component={TradeHistory} /><Route path="/risk" component={RiskSettings} /><Route path="/status" component={OperationalStatus} /><Route path="/account" component={AccountSettings} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch></DashboardLayout>;
}
